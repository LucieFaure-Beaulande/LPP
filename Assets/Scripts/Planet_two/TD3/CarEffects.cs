...
public class CarEffects : MonoBehaviour
{
    ...
    /*private void UpdateTurnWheelsEffect()
    {
        ...
        leftWheel.localRotation = Quaternion.Euler(leftWheel.localRotation.eulerAngles.x,  carMovement.input.x * 30f, leftWheel.localRotation.eulerAngles.z);
        rightWheel.localRotation = Quaternion.Euler(rightWheel.localRotation.eulerAngles.x,  carMovement.input.x * 30f, rightWheel.localRotation.eulerAngles.z);
    }*/
